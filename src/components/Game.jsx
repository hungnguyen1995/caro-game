...
class Game extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (this.props.location !== prevProps.location) {
      this.setState({board:this.generateBlankBoard()});
    }
  }
    ...
    if (!this.props.local) {
      return (
        <OnlineGameMessages
          ...
          gameUrl={
            "https://sieuviet-caro.web.app/" + this.props.location.pathname
          }
        />
      );
    }
  ...
  render() {
    ...
    return (
      <div className="game game-area">
        {!this.props.local && <SignIn gameState={this.state} />}
        {this.renderOnlineMsg()}
        <StatusMessages createOnlineGame={this.props.createOnlineGame} uid={uid} gameState={this.state} />
